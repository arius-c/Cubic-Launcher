...
Microsoft authentication uses OAuth 2.0 Authorization Code Flow with PKCE for
desktop public clients. Users authenticate directly with Microsoft; Cubic
Launcher never receives or stores Microsoft passwords.

## License

Cubic Launcher is licensed under the GNU General Public License v3.0. See
